...
namespace Error
{
	...
	ERROR errors[ERROR_MAX_ENTRY] =
	{
		...
		ERROR_ENTRY(143, "Пропущена операция после закрывающей скобки"),
		ERROR_ENTRY(144, "Операции не может быть в скобках"),
		...
		ERROR_ENTRY(161, "Оишбочный оператор"),
		ERROR_ENTRY(162, "Ошибка в выражении"),
		ERROR_ENTRY(163, "Ошибка в параметрах функции"),
		ERROR_ENTRY(164, "Ошибка в параметрах вызываемой функции"),
