...
#define TI_INT_MAX_VALUE	pow(2,31)-1		//максимальное значение дл€ int
#define TI_INT_MIN_VALUE	-pow(2,31)		//минимальное значение дл€ int
...
#define PARM_ID_DEFAULT_EXT L".id.txt" //дл€ файла с результатом лексического анализa(идентификаторы и литералы)
