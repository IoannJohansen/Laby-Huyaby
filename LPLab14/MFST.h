...
namespace MFST
{
	struct MfstState							   //состояние автомата(для сохранения
	{
		...
		MfstState();
		MfstState(short pposition,				   //позиция на ленте
	...
	struct Mfst									   //магазинный автомат
	{
		...
		struct MfstDiagnosis						//диагностика
		{
			...
			MfstDiagnosis();
			MfstDiagnosis(short plenta_position,	 //диагностика
		...
		Mfst();
		Mfst(Lex::Tables plex,						   //результат работы лексического анализатора
